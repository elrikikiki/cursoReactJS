...
import festival from './img/imgs/festival.png'
import descuento from './img/imgs/descuento.png'
import selesao from './img/imgs/selesao.png'
  ...
  return ( //en App siempre voy a tener las rutas pa
    ...
    lógica unicamente desde App, y eso no quiero. Clase 10 1:00hs */}
      <Navbar saludo='BIRREX' edad={28} nombre ='santi'/>
        <Routes>
            <Route path='/' element={<ItemListContainer greeting='Bienvenidos a Birrex' img={festival} img2={descuento} img3={selesao}/>}/> 
            <Route path='/detail/:idProd' element={<ItemDetailContainer/>}/>
            <Route path='/category/:categoryName' element={<ItemListContainer img={festival} img2={descuento} img3={selesao}/>}/>
